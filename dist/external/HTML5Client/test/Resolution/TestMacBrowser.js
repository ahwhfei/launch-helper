(function() {
    ...
    macbrowsers[macbrowsers.length] = {
        isTouchOS : false,
        appVersion : "5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.75 Safari/537.36",
        orientation : {
            'key' : 'orientation',
            'value' : {
                angle : 0,
        ...
        browser : 'CHROME',
        userAgent : "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.75 Safari/537.36"
    };

    macbrowsers[macbrowsers.length] = {
        isTouchOS : false,
        appVersion : "5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/600.5.17 (KHTML, like Gecko) Version/8.0.5 Safari/600.5.17",
        browser : 'safari',
    ...
    for (var i = 0; i < macbrowsers.length; i++) {
        executeTestCase(macbrowsers[i]);
    }
