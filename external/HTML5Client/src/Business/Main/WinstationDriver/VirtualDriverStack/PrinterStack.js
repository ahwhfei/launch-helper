function PrinterStack() {
    ...
    var PR_MODULE_PARAMETERS = new VirtualDriverParameter("Printer", minimumVersion, maximumVersion, "CTXCPM ", 0x1000, SupportedEncoding.ASCII_ENCODING, 0);
...
PrinterStack.prototype = new VirtualDriver();
